...
#define FFT_BLOCK_LENGTH	128     /*256 = Number of frequency points in the FFT */
#define LOG2_BLOCK_LENGTH 	7		/*8 = Number of "Butterfly" Stages in FFT processing */
...
const fractcomplex [] __attribute__ ((space(auto_psv), aligned (FFT_BLOCK_LENGTH*2*2))) =
        {
